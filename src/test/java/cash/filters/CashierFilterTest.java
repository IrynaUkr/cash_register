...
public class CashierFilterTest {
    final private CashierFilter testFilter = new CashierFilter();
    ...
    @Test
    public void doFilterCashierCallTest() throws ServletException, IOException {
